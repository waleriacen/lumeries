...
function FreeMoonPosterPage() {
  ...
  const handleGetFreePoster = async () => {
    ...
    if (!coordinates) {
      alert(t.locationRequired || 'Please select a location');
      return;
    }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">
                  {t.name2Label} <span className="text-gray-400 font-normal">{t.optional}</span>
                </label>
                <input
                  type="text"
                  value={name2}
...
export default function FreeMoonPosterPageWrapper() {
  return (
